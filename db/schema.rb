...
ActiveRecord::Schema.define(version: 2019_09_06_063455) do
  ...
  create_table "articles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.integer "statuses_mask", default: 1
    t.boolean "mini", default: false
  ...
  create_table "urls", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
